model pipeValidation4
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipe(redeclare package Medium = Medium, diameter = 0.022,  length = 5, modelStructure = Modelica.Fluid.Types.ModelStructure.av_vb, roughness = 1.1e-05) annotation(
  ...
  Modelica.Blocks.Sources.RealExpression epsilon(y = pipe.roughness * 1e-3) annotation(
